...
public class Login extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    try {
      ...
      ResultSet ambilDataYang = crud.ambilData("akun WHERE nama = '" + tNama.getText() + "' and password = '" + StringToMD5 + "'");
      if (ambilDataYang.next()) {
  ...
  private void tNamaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tNamaFocusLost
    ...
    if (succes[0]) {
      ...
      succes[0] = crud.ValidasiDataTidakTerdaftar(tNama, "nama", ambilData);
      if (!(succes[0])) {
        btnRegister.setVisible(true);
      } else {
        btnRegister.setVisible(false);
  ...
  private void tPassFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tPassFocusLost
    ...
    if (succes[1]) {
      try {
        String pass = tPass.getText();
        String StringToMD5 = crud.StringToMD5(pass);
        ResultSet ambilData = crud.ambilData(" akun WHERE nama = '" + tNama.getText() + "' and password ='" + StringToMD5 + "'");
        succes[1] = crud.ValidasiDataTidakTerdaftar(tNama, "nama", ambilData);
        if (succes[1]) {
